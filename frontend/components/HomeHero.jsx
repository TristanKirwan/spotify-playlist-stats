      ...
      <Container containerClass="grid gap-10 justify-center lg:justify-start homecontainer">
        ...
        <div className="flex flex-col gap-8">
          <div className="flex flex-col">
            <p className="overflow-hidden opacity-0 font-barlow-semibold" ref={welcomeText}>Welcome to</p>
            <h1 className="pb-1.5 overflow-hidden text-heading-1 font-barlow-bold opacity-0 md:whitespace-nowrap xl:pb-7" ref={headingTextRef} id="test">
              Spoti-Stats
            </h1>
          </div>
          <div className="flex flex-col items-start gap-4">
            <p className="max-w-sm opacity-0 lg:max-w-md" ref={introText}>
              Ever wondered which artists dominate your (collaborative) playlists, or what starting letter is the most common among your tracks? <br /> Wonder no longer.
            </p>
            <Cta isLink href={authLink} smallerText={false} passedRef={ctaButtonRef} className="opacity-0">
              Get started
            </Cta>
          </div>
        </div>
